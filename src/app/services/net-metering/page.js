    ...
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-gray-700 text-lg leading-relaxed mb-16">
          ...
          <p className="font-semibold text-[#82C701]">
        ...
        <div className="my-16">
          ...
          <div className="flex flex-col md:flex-row items-start gap-10">
            ...
            <div className="md:w-1/2 space-y-6 text-gray-700 text-lg leading-relaxed">
              ...
              <h3 className="text-2xl font-bold text-[#082E6F] mt-8 mb-4">HERE'S HOW IT WORKS</h3>
              <p>
        ...
        <div className="my-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 h-full">
              <h2 className="text-xl font-bold text-[#082E6F] mb-4 pb-2 border-b-2 border-[#82C701]">Less Cost, Most Benefits</h2>
              ...
              <p className="text-gray-700 leading-relaxed">
                For their valuable clients, <span className="font-semibold text-[#82C701]">GO GREEN POWER WITH SUN SOLAR</span>, a company with years of experience and certified by AEDB in Pakistan, offers reasonable net metering rates in Pakistan.
              </p>
            </div>

            {/* Card 2 */}
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 h-full">
              <h2 className="text-xl font-bold text-[#082E6F] mb-4 pb-2 border-b-2 border-[#82C701]">Sell and Earn</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            {/* Card 3 */}
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 h-full">
              <h2 className="text-xl font-bold text-[#082E6F] mb-4 pb-2 border-b-2 border-[#82C701]">20–40% Utilization</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
