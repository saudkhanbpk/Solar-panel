...
const Page = () => {
  return (
    <div>
      <div className="flex justify-center text-center items-center bg-[url(/services-home.png)] bg-cover bg-center h-64">
      </div>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        <h1 className='text-center text-3xl font-bold text-gray-800 mb-8 border-l-[5px] border-r-[5px] border-gray-800' >SOLAR SYSTEM SERVICES</h1>
        <div className="space-y-4 text-gray-700 leading-relaxed mb-5">
          <p>
            At <span className="font-semibold">GO GREEN POWER WITH SUN</span>, we provide
          ...
          <p>
            ...
            <span className="font-semibold">GO GREEN POWER WITH SUN</span> ensures
            professional service with guaranteed performance and long-term durability.
          </p>

          <p>
            By choosing <span className="font-semibold">GO GREEN POWER WITH SUN</span>,
        ...
        <StatsSection />
        <h1 className='scroll-mt-24 text-center text-3xl font-bold text-gray-800 mb-8 border-l-[5px] border-r-[5px] border-gray-800' id="solar-consultancy">Solar System Consultancy</h1>
        <div className="space-y-6 text-gray-700">
          <div>
            <h2 className="text-xl font-semibold text-green-600">Local Expertise</h2>
            <p>
              With years of experience in Pakistan’s solar energy sector,
              <b> GO GREEN POWER WITH SUN </b> understands the specific climate conditions,
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Extensive Experience</h2>
            <p>
              ...
              <b> GO GREEN POWER WITH SUN </b> brings technical know-how,
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Quality Assurance</h2>
            <p>
              ...
              <b> GO GREEN POWER WITH SUN </b> ensures that you not only
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Customer-Centric Approach</h2>
            <p>
              At <b> GO GREEN POWER WITH SUN </b>, our clients are at the heart of everything we do.
        ...
        {/* Installation */}
        <h1 id="solar-installation" className="scroll-mt-24 text-center text-3xl font-bold text-gray-800 my-8 border-l-[5px] border-r-[5px] border-gray-800">
          Solar System Installation
        </h1>
        <div><div className="space-y-6 text-gray-700">
          <div>
            <h2 className="text-xl font-semibold text-green-600">Professional Setup</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Safety Standards</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Timely Execution</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">After-Support</h2>
            <p>
        ...
        {/* Maintenance */}
        <h1 id="solar-maintenance" className=" scroll-mt-24 text-center text-3xl font-bold text-gray-800 my-8 border-l-[5px] border-r-[5px] border-gray-800">
          Solar System Maintenance
        </h1>
        <div className="space-y-6 text-gray-700">
          <div>
            <h2 className="text-xl font-semibold text-green-600">Routine Inspections</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Performance Optimization</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Component Replacement</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-green-600">Emergency Support</h2>
            <p>
        ...
        {/* Cleaning */}
        <h1 id="solar-cleaning" className="scroll-mt-24 text-center text-3xl font-bold text-gray-800 my-8 border-l-[5px] border-r-[5px] border-gray-800">
          Solar System Cleaning
        </h1>
        <div>
          <div className="space-y-6 text-gray-700">
            <div>
              <h2 className="text-xl font-semibold text-green-600">Dust Removal</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-semibold text-green-600">Eco-Friendly Cleaning</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-semibold text-green-600">Scheduled Services</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-semibold text-green-600">Maximized Efficiency</h2>
              <p>
